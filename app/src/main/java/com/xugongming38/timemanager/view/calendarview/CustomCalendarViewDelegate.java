...
//    Calendar mIndexCalendar;
    ...
    CustomCalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs,R.styleable.CalendarView);//com.haibin.calendarview.R.styleable.CalendarView

        LunarCalendar.init(context);

        mSchemeTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_scheme_text_color, 0xFFFFFFFF);
        mSchemeLunarTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_scheme_lunar_text_color, 0xFFe1e1e1);
        mSchemeThemeColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_scheme_theme_color, 0x50CFCFCF);
        mMonthViewClass = array.getString(com.xugongming38.timemanager.R.styleable.CalendarView_month_view);

        mWeekViewClass = array.getString(com.xugongming38.timemanager.R.styleable.CalendarView_week_view);
        mWeekBarClass = array.getString(com.xugongming38.timemanager.R.styleable.CalendarView_week_bar_view);
        mWeekBarHeight = (int) array.getDimension(com.xugongming38.timemanager.R.styleable.CalendarView_week_bar_height, Util.dipToPx(context, 40));

        mSchemeText = array.getString(com.xugongming38.timemanager.R.styleable.CalendarView_scheme_text);
        if (TextUtils.isEmpty(mSchemeText)) {
            mSchemeText = "记";
        }
        mMonthViewShowMode = array.getInt(com.xugongming38.timemanager.R.styleable.CalendarView_month_view_show_mode, MODE_ALL_MONTH);
        //mSelectMode = array.getInt(R.styleable.CalendarView_select_mode, SELECT_MODE_DEFAULT);

        mWeekBackground = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_week_background, Color.WHITE);
        mWeekLineBackground = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_week_line_background, Color.TRANSPARENT);
        mYearViewBackground = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_year_view_background, Color.WHITE);
        mWeekTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_week_text_color, 0xFF333333);

        mCurDayTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_current_day_text_color, Color.RED);
        mCurDayLunarTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_current_day_lunar_text_color, Color.RED);

        mSelectedThemeColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_selected_theme_color, 0x50CFCFCF);
        mSelectedTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_selected_text_color, 0xFF111111);

        mSelectedLunarTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_selected_lunar_text_color, 0xFF111111);
        mCurrentMonthTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_current_month_text_color, 0xFF111111);
        mOtherMonthTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_other_month_text_color, 0xFFe1e1e1);

        mCurMonthLunarTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_current_month_lunar_text_color, 0xffe1e1e1);
        mOtherMonthLunarTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_other_month_lunar_text_color, 0xffe1e1e1);
        mMinYear = array.getInt(com.xugongming38.timemanager.R.styleable.CalendarView_min_year, 1971);
        mMaxYear = array.getInt(com.xugongming38.timemanager.R.styleable.CalendarView_max_year, 2055);
        mMinYearMonth = array.getInt(com.xugongming38.timemanager.R.styleable.CalendarView_min_year_month, 1);
        mMaxYearMonth = array.getInt(com.xugongming38.timemanager.R.styleable.CalendarView_max_year_month, 12);

        mDayTextSize = array.getDimensionPixelSize(com.xugongming38.timemanager.R.styleable.CalendarView_day_text_size, Util.dipToPx(context, 16));
        mLunarTextSize = array.getDimensionPixelSize(com.xugongming38.timemanager.R.styleable.CalendarView_lunar_text_size, Util.dipToPx(context, 10));
        mCalendarItemHeight = (int) array.getDimension(com.xugongming38.timemanager.R.styleable.CalendarView_calendar_height, Util.dipToPx(context, 56));

        //年视图相关
        mYearViewMonthTextSize = array.getDimensionPixelSize(com.xugongming38.timemanager.R.styleable.CalendarView_year_view_month_text_size, Util.dipToPx(context, 18));
        mYearViewDayTextSize = array.getDimensionPixelSize(com.xugongming38.timemanager.R.styleable.CalendarView_year_view_day_text_size, Util.dipToPx(context, 8));
        mYearViewMonthTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_year_view_month_text_color, 0xFF111111);
        mYearViewDayTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_year_view_day_text_color, 0xFF111111);
        mYearViewSchemeTextColor = array.getColor(com.xugongming38.timemanager.R.styleable.CalendarView_year_view_scheme_color, mSchemeThemeColor);
